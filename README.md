...
- An R package to detect multiple change points in time series of graphs, using Separable Temporal Exponential-family Random Graph Model (STERGM) and solved by Alternating Direction Method of Multipliers (ADMM) with Group Fused Lasso
