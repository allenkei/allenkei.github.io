...
I am interested in gaining a better understanding of complex data to tackle real-world problems. Specifically, my research aims to develop realistic models and the associated inference and learning algorithms for multi-modal data, such as time series, graphs, and language, to allow useful **abstraction**, **generation**, and **detection**. Extracting meaningful representations from data (*abstraction*) can help devise powerful models that produce valid knowledge in a real-world setting (*generation*), while identifying anomalies when certain criteria are violated (*detection*).
